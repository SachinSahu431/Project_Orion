                ...
                <table class="table table-hover table-striped">
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <img src={user} class="img-circle" width="60" />
                      </td>
                      <td>
                        <h4>
                          <b>Ramón Villa Awad</b>
                        </h4>
                        <a href="mailto:ramonvillaw@gmail.com">
                    ...
                    <tr>
                      <td>
                        <a href="#">
                          <i class="fa fa-2x fa-fw fa-eye-slash"></i>
                        </a>
                      </td>
                      <td>
                        <h4>
                    ...
                    <tr>
                      <td>
                        <a href="#">
                          <i class="fa fa-2x fa-fw fa-eye"></i>
                        </a>
                      </td>
                      <td>
                        <h4>
                    ...
                    <tr>
                      <td>
                        <a href="#">
                          <i class="fa fa-2x fa-fw -alt fa-eye-slash"></i>
                        </a>
                      </td>
                      <td>
                        <h4>
              ...
              <div class="modal-body">
                <form class="form-horizontal">
                  <fieldset>
                    ...
                    <div class="form-group">
                      <label class="col-md-4 control-label" for="departamento">
                        Departamento
                      </label>
                      <div class="col-md-5">
                        <select
          ...
          <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbar-ex-collapse">
              <ul class="nav navbar-nav navbar-right">
                <li>
                  <a href="#">
                    <i class="fa fa-fw fa-dashboard"></i> Configuración
                  </a>
                </li>
                <li class="dropdown">
                  <a
                    ...
                    aria-expanded="false"
                  >
                    Ramón Villa <span class="caret"></span>
                  </a>
