      ...
      <div className="row h-100 p-0 position-relative">
        ...
        >
          <ul className="list-group mt-1 list-group-flush">
            ...
            <Link to="/legal" className="list-group-item list-group-item-action">RTI & Legal Cell</Link>
            <Link to="/staff_service" className="list-group-item">
              <span>Staff Services</span>
              <ul className="list-group list-group-flush within-list" id="staff-list">
                <Link to="/staff_services/cea_allowance" className="list-group-item list-group-item-action">CEA Allowance</Link>
                <Link to="/staff_service/service_records" className="list-group-item list-group-item-action">Institute Service Records</Link>
                <Link to="/staff_service/attendance" className="list-group-item list-group-item-action">Staff Attendance Management</Link>
                <Link to="/staff_service/payment" className="list-group-item list-group-item-action">Staff Payment Management</Link>
                <Link to="/staff_service/performance" className="list-group-item list-group-item-action">Staff Performance Management</Link>
              </ul>
            </Link>
            <Link to="/training" className="list-group-item list-group-item-action">Training Management</Link>
            <Link to="/property_returns" className="list-group-item list-group-item-action">Annual Property Returns</Link>
            <Link to="/visiting" className="list-group-item list-group-item-action">Adjunct/Visiting Faculty Details</Link>
            <Link to="/faculty_recruitment" className="list-group-item list-group-item-action">Faculty Recruitment Portal</Link>
            <Link to="/staff_recruitment" className="list-group-item list-group-item-action">Staff Recruitment Portal</Link>
          </ul>
        </div>
        <div
        ...
        >
          <Routes>
            ...
            */}
            ...
            <Route path="/property_returns" element={<PropertyReturns/>}></Route>
            <Route path="/visiting" element={<Visiting/>}></Route>
            <Route path="/faculty_recruitment" element={<FacultyRecruitment/>}></Route>
            <Route path="/staff_recruitment" element={<StaffRecruitment/>}></Route>
          </Routes>
        </div>
      </div>
    </div>
