                  ...
                  <div className="row mb-3">
                    ...
                    <div className="col-sm-9">
                      <div className="d-flex flex-row justify-content-between align-items-center">
                        <select id="sr-year" className="form-select me-1" required>
                          <option></option>
                        ...
                        <select id="sr-month" className="form-select mx-1" required>
                          <option></option>
                        ...
                        <select id="sr-day" className="form-select ms-1" required>
                          <option></option>
